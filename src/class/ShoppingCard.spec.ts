...
describe('shoppingCart', () => {
  ...
  it('should calldiscount.calculat when totalwith discount is called', () => {
    const { sut, dm } = createSUTWithProducts()
    const discountMockSpy = jest.spyOn(dm, 'Calculate')
    sut.TotalWidthDicount
